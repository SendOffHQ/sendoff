...
(function () {
  ...
  // ---------- expose ----------
  window.Race = { fmt, units, slug, qs, raceHref, poll, raceState, POLL_MS, hub, config, auth, share, api, gh, queue, roles, plans, archive, activities, nav, course, stationAt, fuel, compute, gpx, charts, access, mountAccountWidget, mountBetaBadge, offline, lastSeen, feedback, openFeedbackModal };
})();
