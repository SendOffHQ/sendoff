...
(function () {
  ...
  function openSigninModal() {
    ...
    m.body.innerHTML =
      ...
      '<p class="modal-hint">Forgot your password? Ask your hub admin to send you a reset link.<br>' +
        'No account yet? <a href="mailto:invites@sendoff.run?subject=SendOff%20invite%20request&body=I%27d%20like%20an%20account%20on%20SendOff.%0A%0AName%3A%0ARace%20I%27m%20crewing%3A%0ADate%3A%0A%0AAnything%20else%20worth%20knowing%3A%0A" style="color: var(--accent);">Request an invite</a>.</p>';
    const submit = async () => {
