...
(function () {
  ...
  function openFeedbackModal() {
    ...
    m.body.innerHTML =
      '<p class="modal-lede">What happened, and what did you expect instead? ' +
        'The page, the race and the version go with it, so no need to describe those.</p>' +
  ...
  // ---------- expose ----------
  window.Race = { fmt, units, slug, qs, hub, config, auth, share, api, gh, queue, roles, plans, archive, nav, course, stationAt, fuel, compute, gpx, charts, access, mountAccountWidget, mountBetaBadge, offline, lastSeen, feedback, openFeedbackModal };
})();
